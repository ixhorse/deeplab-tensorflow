...
_TT100K_INFORMATION = DatasetDescriptor(
    splits_to_sizes={
        'train': 6105,  # num of samples in images/training
        'val': 3071,  # num of samples in images/validation
    },
    num_classes=2,
    ignore_label=255,
)
